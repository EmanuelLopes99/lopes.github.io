...
class AboutSearch extends About
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['missao', 'filosofia', 'descrecaoEquipe', 'imagem_about'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'missao', $this->missao])
            ...
            ->andFilterWhere(['like', 'descrecaoEquipe', $this->descrecaoEquipe])
            ->andFilterWhere(['like', 'imagem_about', $this->imagem_about]);
